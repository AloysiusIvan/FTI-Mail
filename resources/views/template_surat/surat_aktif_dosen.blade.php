...
<body>
    ...
    <p><br></p>
    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;text-align:center;'><strong><u><span style='font-size:16px;line-height:150%;font-family:"Times New Roman",serif;'>SURAT KETERANGAN AKTIF MENGAJAR</span></u></strong></p>
    ...
    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:65pt;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><span style='font-size:16px;line-height:150%;font-family:"Times New Roman",serif;'>NID&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{$item->username}}</span></p>
    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:65pt;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><span style='font-size:16px;line-height:150%;font-family:"Times New Roman",serif;'>Jabatan &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: @foreach($dosen as $dosen){{$dosen->jabatan}}@endforeach</span></p>
    ...
    <p style='margin-top:0cm;margin-right:0.75cm;margin-bottom:8.0pt;margin-left:1cm;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><span style='font-size:16px;line-height:150%;font-family:"Times New Roman",serif;'>Nama tersebut di atas adalah Dosen Fakultas Teknologi Informasi Universitas Kristen Duta Wacana Yogyakarta terdaftar pada tanggal @foreach($masuk as $masuk){{$masuk->tgl_masuk->format('d F Y')}}@endforeach dan aktif melaksanakan tugas mengajar. Surat ini untuk keperluan {{$item->keterangan}}.</span></p>
