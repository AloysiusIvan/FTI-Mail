			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="#editSuratModal" class="edit" data-toggle="modal" data-target="#editSuratModal{{$item->id}}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="#deleteSuratModal" class="delete" data-toggle="modal" data-target="#deleteSuratModal{{$item->id}}"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					@endforeach
				</tbody>
